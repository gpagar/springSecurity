...
public class MyJwtTokenStore  implements TokenStore{
	...
	private MyTokenServices jwtTokenEnhancer;
	 ...
	 */
	public MyJwtTokenStore(MyTokenServices jwtTokenEnhancer) {
	...
	public void setTokenEnhancer(MyTokenServices tokenEnhancer) {
